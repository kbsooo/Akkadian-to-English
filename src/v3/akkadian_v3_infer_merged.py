#%% [markdown]
# # Akkadian V3 Inference: Merged Model (PEFT 불필요!)
#
# **Key Features:**
# - Pre-merged model 사용 (LoRA가 이미 base model에 통합됨)
# - PEFT 라이브러리 불필요 → Kaggle Internet OFF에서 작동
# - Same normalization as training for consistent results
#
# **Environment**: Kaggle T4/P100 GPU (Internet OFF 지원)
...
#%%
print("=" * 60)
print("🚀 Akkadian V3 Inference: Merged Model")
print("=" * 60)
